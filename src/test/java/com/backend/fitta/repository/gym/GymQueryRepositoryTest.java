...
class GymQueryRepositoryTest {
    ...
    public void init(){
        ...
        Gym gym1 = new Gym("gym1", findOwner,null,null, "01-0000-0000", "gymAddress1", GenderDivision.MALE_ONLY,"123123");
        Gym gym2 = new Gym("gym2", findOwner,null,null, "02-0000-0000", "gymAddress2", GenderDivision.FEMALE_ONLY,"123123");
        Gym gym3 = new Gym("gym3", findOwner,null,null, "03-0000-0000", "gymAddress3", GenderDivision.UNISEX,"12312312312");
    ...
    void GymCount() throws Exception{
        ...
        Gym gym1 = new Gym("test1", findOwner, null,null,"01-0000-0000", "gymAddress1", GenderDivision.MALE_ONLY,"123123");
        Gym gym2 = new Gym("test2", findOwner, null,null,"02-0000-0000", "gymAddress2", GenderDivision.FEMALE_ONLY,"12312312");
        Gym gym3 = new Gym("test3", findOwner, null,null,"03-0000-0000", "gymAddress3", GenderDivision.UNISEX,"123123");
        Gym gym4 = new Gym("test4", findOwner, null,null,"03-0000-0000", "gymAddress3", GenderDivision.UNISEX,"12312312321");
