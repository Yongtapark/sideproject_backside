...
class GymQueryRepositoryTest {
    ...
    public void init(){
        ...
        Gym gym1 = new Gym("gym1", findOwner, "01-0000-0000", "gymAddress1", GenderDivision.MALE_ONLY);
        Gym gym2 = new Gym("gym2", findOwner, "02-0000-0000", "gymAddress2", GenderDivision.FEMALE_ONLY);
        Gym gym3 = new Gym("gym3", findOwner, "03-0000-0000", "gymAddress3", GenderDivision.UNISEX);
    ...
    void GymCount() throws Exception{
        ...
        Gym gym1 = new Gym("test1", findOwner, "01-0000-0000", "gymAddress1", GenderDivision.MALE_ONLY);
        Gym gym2 = new Gym("test2", findOwner, "02-0000-0000", "gymAddress2", GenderDivision.FEMALE_ONLY);
        Gym gym3 = new Gym("test3", findOwner, "03-0000-0000", "gymAddress3", GenderDivision.UNISEX);
        Gym gym4 = new Gym("test4", findOwner, "03-0000-0000", "gymAddress3", GenderDivision.UNISEX);
